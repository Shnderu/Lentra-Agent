...
class GraphFileRegistry:
    ...
    This is NOT heuristic logic.
    This is a deterministic index layer.
    """

    def __init__(self):
        self.node_to_files: Dict[str, List[str]] = {
            "risk_engine": [
                "lentra/core/market_intelligence/risk/risk_engine.py",
            ...
            "dedup_engine": [
                ...
                "lentra/core/market_intelligence/dedup/unified_dedup_engine.py",
            ],
            "area_engine": [
